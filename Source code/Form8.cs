...
namespace Proiect_atestat
{
    public partial class Form8 : Form
    {
        ...
        public Form8(string u)
        {
            ...
            string query = "SELECT TOP(1) Scor FROM [" + username + " joc2]" + " ORDER BY Date DESC";
            ...
            query = "SELECT TOP(1) Scor FROM [" + username + " joc2]" + " ORDER BY Scor DESC";
            ...
            query = "SELECT TOP(1) Scor FROM [Joc2] ORDER BY Scor DESC";
            sda = new SqlDataAdapter(query, sqlcon);
            dtb1 = new DataTable();
            sda.Fill(dtb1);
            row = dtb1.Rows[0];
