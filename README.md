...
## Overview
Test Q is a desktop application that comprises several microgames which asses the user’s cognitive abilities (reaction time, number memory and verbal memory). It can be accessed by downloading and lunching the **Test Q.exe** executable. For testing purposes, a valid username/password combination can be found in the **Username + Password.txt** file.
...
<div align="center">
  ...
  <p>Email example, the attachments are graphs which track the user's score evolution in all the three tests</p>
</div>
